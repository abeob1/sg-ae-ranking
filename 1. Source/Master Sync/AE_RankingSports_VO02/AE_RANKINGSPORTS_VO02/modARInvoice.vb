Module modARInvoice
    ...
    Public Function AR_InvoiceCreation(ByVal oDVARInvoice As DataView, ByVal oDVPayment As DataView, ByRef oCompany As SAPbobsCOM.Company, _
        ...
        Try
            ...
            For Each dvr As DataRowView In oDVARInvoice
                ...
                ssql = "SELECT T0.[WhsCode] FROM OWHS T0 WHERE T0.[U_AB_POSLocCode]  = '" & dvr("DOutlet").ToString.Trim & "'"
                If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Getting Whscode " & ssql, sFuncName)
                oRset.DoQuery(ssql)
                sWhsCode = oRset.Fields.Item("WhsCode").Value
    ...
    Public Function AR_InvoiceCreation_OLD1(ByVal oDVARInvoice As DataView, ByVal oDVPayment As DataView, ByRef oCompany As SAPbobsCOM.Company, ByRef oDTStatus As DataTable, ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            oARInvoice.UserFields.Fields.Item("U_POS_RefNo").Value = oDVARInvoice.Item(0).Row("HPOSTxNo").ToString.Trim
            oARInvoice.UserFields.Fields.Item("U_Date").Value = dIncomeDate
            oARInvoice.UserFields.Fields.Item("U_Time").Value = tDocTime
