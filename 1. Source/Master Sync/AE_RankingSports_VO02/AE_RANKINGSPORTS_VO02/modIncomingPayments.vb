Module modIncomingPayments
    ...
    Function AR_IncomingPayment(ByRef oDVPayment As DataView, ByRef oDICompany As SAPbobsCOM.Company, _
        ...
        Try
            ...
            oIncomingPayment.CounterReference = oDVPayment.Item(0).Row("POSTxNo").ToString.Trim
            oIncomingPayment.UserFields.Fields.Item("U_AB_POSTxNo").Value = oDVPayment.Item(0).Row("POSTxNo").ToString.Trim
            ...
            For Each drv In oDVPayment
                ...
                oIncomingPayment.CreditCards.VoucherNum = drv("CompanyId").ToString.Trim
